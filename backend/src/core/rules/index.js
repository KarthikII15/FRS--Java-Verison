...
import { AgeGenderClassifyRule, GenderDemographicsRule } from './DemographicsRules.js';
import { AlprDetectionRule, HelmetWeaponRule, BackdoorEntryViolationRule } from './SecurityRules.js';
import { FallDownRule } from './SafetyRules.js';
import { ATMSafeOrHoodOpenRule, VaultPersonDwellTimeRule } from './RetailAndBankingRules.js';
import { TrainArrivalDepartureRule, PmsRule, TrainIntrusionRule, VehicleZoneIntrusionRule, PmsRuleEnableOnPi } from './TrafficAndTransitRules.js';
import { OverCrowdingRule, SmartOccupancyRule } from './OccupancyAndPresenceRules.js';
import { CameraAngleChange, CameraTemperOrCovered, CameraTemper } from './DeviceManagementRules.js';
import { AnimalCountingRule, LoiteringRule, LoiteringObjectRule, CleanlinessRule, InsectPresenceRule, PetWithoutPersonRule } from './MiscellaneousRules.js';
/**
...
export function getRuleClassByType(ruleType) {
  switch (ruleType) {
    ...
    case 'LoiteringObject':
    case 'LoiteringObjectRule':
      return LoiteringObjectRule;
    case 'FireSmoke':
    case 'FireSmokeRule':
    ...
    // ----- New Rule Mappings -----
    case 'AgeGenderClassify':
    case 'AgeGenderClassifyRule':
      return AgeGenderClassifyRule;
    case 'GenderDemographics':
    case 'GenderDemographicsRule':
      return GenderDemographicsRule;
    case 'AlprDetection':
    case 'AlprDetectionRule':
      return AlprDetectionRule;
    case 'HelmetWeapon':
    case 'HelmetWeaponRule':
      return HelmetWeaponRule;
    case 'BackdoorEntryViolation':
    case 'BackdoorEntryViolationRule':
      return BackdoorEntryViolationRule;
    case 'FallDown':
    case 'FallDownRule':
      return FallDownRule;
    case 'ATMSafeOrHoodOpen':
    case 'ATMSafeOrHoodOpenRule':
      return ATMSafeOrHoodOpenRule;
    case 'VaultPersonDwellTime':
    case 'VaultPersonDwellTimeRule':
      return VaultPersonDwellTimeRule;
    case 'TrainArrivalDeparture':
    case 'TrainArrivalDepartureRule':
      return TrainArrivalDepartureRule;
    case 'Pms':
    case 'PmsRule':
      return PmsRule;
    case 'OverCrowding':
    case 'OverCrowdingRule':
      return OverCrowdingRule;
    case 'SmartOccupancy':
    case 'SmartOccupancyRule':
      return SmartOccupancyRule;
    case 'CameraAngleChange':
    case 'CameraAngleChangeRule':
      return CameraAngleChange;
    case 'CameraTemperOrCovered':
    case 'CameraTemperOrCoveredRule':
      return CameraTemperOrCovered;
    case 'CameraTemper':
    case 'CameraTemperRule':
      return CameraTemper;
    case 'InsectPresence':
    case 'InsectPresenceRule':
      return InsectPresenceRule;
    case 'PetWithoutPerson':
    case 'PetWithoutPersonRule':
      return PetWithoutPersonRule;
    case 'TrainIntrusion':
    case 'TrainIntrusionRule':
      return TrainIntrusionRule;
    case 'VehicleZoneIntrusion':
    case 'VehicleZoneIntrusionRule':
      return VehicleZoneIntrusionRule;
    case 'PmsRuleEnableOnPi':
      return PmsRuleEnableOnPi;
    default:
      return null;
  }
}
